...
block2:
        ...
        MOVL         t102-1033(SP), R9
        MOVL         t104-1045(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         t105-1049(SP), R9
        MOVL         t107-1061(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $0, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         t108-1065(SP), R9
        MOVL         t110-1077(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $1, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         t111-1081(SP), R9
        MOVL         t113-1093(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $2, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         t114-1097(SP), R9
        MOVL         t116-1109(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         t117-1113(SP), R9
        MOVL         t119-1125(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVL         R8, t120-1129(SP)
        MOVL         t85-941(SP), R9
        MOVL         t120-1129(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X9, t21-48(SP)
        MOVQ         $0, SI
        ...
        MOVL         t121-1133(SP), R9
        MOVL         t123-1145(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X6, t35-96(SP)
        MOVQ         $1, SI
        ...
        MOVL         t124-1149(SP), R9
        MOVL         t126-1161(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X3, t49-144(SP)
        MOVQ         $2, SI
        ...
        MOVL         t127-1165(SP), R9
        MOVL         t129-1177(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVL         R8, ret0+48(FP)
        RET
