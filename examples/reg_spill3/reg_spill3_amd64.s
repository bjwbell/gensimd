...
block2:
        ...
        JMP block5
block3:
        MOVLQZX      t3-261(SP), R15
        MOVL         R15, t156-281(SP)
        MOVQ         $0, R14
        MOVQ         R14, t157-289(SP)
        MOVLQZX      t5-273(SP), R13
        MOVL         R13, t158-293(SP)
        MOVLQZX      t6-277(SP), R12
...
block6:
        ...
        MOVL         (R10), R9
        MOVL         R9, t76-1082(SP)
        MOVLQZX      t74-1070(SP), R8
        MOVLQZX      t76-1082(SP), R10
        MOVL         R8, R9
        ADDL         R10, R9
        MOVQ         $2, BX
        IMUL3Q       $4, BX, BX
        ...
        MOVL         DI, t82-1114(SP)
        MOVL         R8, t80-1102(SP)
        MOVLQZX      t80-1102(SP), R9
        MOVLQZX      t82-1114(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $0, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         SI, t85-1130(SP)
        MOVL         R8, t83-1118(SP)
        MOVLQZX      t83-1118(SP), R9
        MOVLQZX      t85-1130(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $1, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         SI, t88-1146(SP)
        MOVL         R8, t86-1134(SP)
        MOVLQZX      t86-1134(SP), R9
        MOVLQZX      t88-1146(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $2, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         SI, t91-1162(SP)
        MOVL         R8, t89-1150(SP)
        MOVLQZX      t89-1150(SP), R9
        MOVLQZX      t91-1162(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         SI, t94-1178(SP)
        MOVL         R8, t92-1166(SP)
        MOVLQZX      t92-1166(SP), R9
        MOVLQZX      t94-1178(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $0, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         SI, t97-1194(SP)
        MOVL         R8, t95-1182(SP)
        MOVLQZX      t95-1182(SP), R9
        MOVLQZX      t97-1194(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $1, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVL         R8, t98-1198(SP)
        MOVLQZX      t98-1198(SP), R9
        MOVLQZX      t100-1210(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $2, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t101-1214(SP), R9
        MOVLQZX      t103-1226(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t104-1230(SP), R9
        MOVLQZX      t106-1242(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X10, t15-32(SP)
        MOVQ         $0, SI
        ...
        MOVLQZX      t109-1258(SP), R9
        MOVLQZX      t111-1270(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $2, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t112-1274(SP), R9
        MOVLQZX      t114-1286(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t115-1290(SP), R9
        MOVLQZX      t117-1302(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $0, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t118-1306(SP), R9
        MOVLQZX      t120-1318(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $1, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t121-1322(SP), R9
        MOVLQZX      t123-1334(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $2, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t124-1338(SP), R9
        MOVLQZX      t126-1350(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t127-1354(SP), R9
        MOVLQZX      t129-1366(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $0, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t130-1370(SP), R9
        MOVLQZX      t132-1382(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $1, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t133-1386(SP), R9
        MOVLQZX      t135-1398(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $2, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t136-1402(SP), R9
        MOVLQZX      t138-1414(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         $3, SI
        IMUL3Q       $4, SI, SI
        ...
        MOVLQZX      t139-1418(SP), R9
        MOVLQZX      t141-1430(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVL         R8, t142-1434(SP)
        MOVLQZX      t107-1246(SP), R9
        MOVLQZX      t142-1434(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X4, t29-80(SP)
        MOVQ         $0, SI
        ...
        MOVLQZX      t143-1438(SP), R9
        MOVLQZX      t145-1450(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X1, t49-160(SP)
        MOVQ         $1, SI
        ...
        MOVLQZX      t146-1454(SP), R9
        MOVLQZX      t148-1466(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVOU        X2, t69-240(SP)
        MOVQ         $2, SI
        ...
        MOVLQZX      t149-1470(SP), R9
        MOVLQZX      t151-1482(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVL         R8, t152-1486(SP)
        MOVLQZX      t156-281(SP), R9
        MOVLQZX      t152-1486(SP), R10
        MOVL         R9, R8
        ADDL         R10, R8
        MOVQ         t157-289(SP), SI
        MOVQ         $1, BX
...
block7:
        ...
        MOVQ         R14, R15
        ADDQ         R13, R15
        MOVLQZX      t156-281(SP), R12
        MOVL         R12, t3-261(SP)
        MOVQ         R15, t4-269(SP)
        MOVLQZX      t158-293(SP), R14
        MOVL         R14, t5-273(SP)
        MOVLQZX      t159-297(SP), R11
        MOVL         R11, t6-277(SP)
